...
g2o::VertexSE3* GraphSLAM::add_se3_node(const Eigen::Isometry3d& pose,
  ...
  vertex->setEstimate(pose); //assign pose to vertex
...
bool GraphSLAM::remove_room_node(g2o::VertexRoom* room_vertex) {
  std::cout<<"@@@@@@@    remove_room_node"<<std::endl;
...
g2o::EdgePlaneIdentity* GraphSLAM::copy_plane_identity_edge(g2o::EdgePlaneIdentity* e,
                                               g2o::VertexPlane* v1,
                                               g2o::VertexPlane* v2) {
  g2o::EdgePlaneIdentity* edge(new g2o::EdgePlaneIdentity());
  edge->setId(e->id());
...
g2o::Edge2Planes* GraphSLAM::add_2planes_edge(g2o::VertexPlane* v_plane1,
  ...
  edge->setInformation(information);
  edge->vertices()[0] = v_plane1;
  // std::cout<<"v_plane1 "<<v_plane1->id()<<"v_plane2 "<<v_plane2->id()<<std::endl;
  edge->vertices()[1] = v_plane2;
  graph->addEdge(edge);
  this->increment_local_nbr_of_edges();
...
// bool GraphSLAM::remove_room_complete_room_edge(g2o::EdgeRoomCompleteRoom* room_complete_room_edge) {
//   bool ack = graph->removeEdge(room_complete_room_edge);

//   return ack;
// }

// g2o::VertexCompleteRoom* GraphSLAM::add_room_node(const Eigen::Isometry3d& room_pose) {
//   g2o::VertexCompleteRoom* vertex(new g2o::VertexCompleteRoom());
//   vertex->setId(static_cast<int>(retrieve_local_nbr_of_vertices()));
//   vertex->setEstimate(room_pose);
//   graph->addVertex(vertex);
//   this->increment_local_nbr_of_vertices();
...
// bool GraphSLAM::remove_room_node(g2o::VertexCompleteRoom* room_vertex) {
//   return graph->removeVertex(room_vertex);
// }
