// #include <s_graphs/backend/complete_room_mapper.hpp>

// namespace s_graphs {

// CompleteRoomMapper::CompleteRoomMapper(const rclcpp::Node::SharedPtr node) {
//   node_obj = node;
//   room_information =
...
// CompleteRoomMapper::~CompleteRoomMapper() {}

// bool CompleteRoomMapper::lookup_rooms(
//       std::shared_ptr<GraphSLAM>& graph_slam,
//       situational_graphs_msgs::msg::CompleteRoomData room_data,
//       std::unordered_map<int, CompleteRooms>& complete_rooms_vec,
//       int& room_id) {
...
//   //add/modify room nodes
//   for (auto& room: complete_rooms_vec){
//     room_cnt = 0;
//     pcl::PointCloud<pcl::PointXYZRGB>::Ptr det_room_convex_hull
//                 (new pcl::PointCloud<pcl::PointXYZRGB>());
//     pcl::PointCloud<pcl::PointXYZRGB> complete_room_convex_hull = room.convex_hull;
//     for (auto& marker: room_data.convex_hull.markers){
//         pcl::PointXYZRGB pt;
//         pt.x = marker.point.x;
//         pt.y = marker.point.y;
//         pt.z = marker.point.z;
//         det_room_convex_hull->points.push_back(pt);
//         if (pcl::isPointIn2DPolygon(pt, complete_room_convex_hull)) room_cnt++;
//     }
//     if (room_cnt == 4){
//       matched_complete_room = room;
//       std::cout<<"det room is included in existing complete room... merging into one"<<std::endl;
//       det_included_in_complete_room(graph_slam,
//                            room_data,
//                            matched_complete_room,
//                            complete_rooms_vec);
//       break;
//     }
//     else if (room_cnt>0){
//       matched_complete_room = room;
//       std::cout<<"complete rooms are overlapped.. merging into one"<<std::endl;
//       det_complete_room_overlapped(graph_slam,
//                            room_data,
//                            matched_complete_room,
//                            complete_rooms_vec);
//       break;
//     }
//     else {
//       for (auto& pt: complete_room_convex_hull.points){
//         if (pcl::isPointIn2DPolygon(pt, *det_room_convex_hull)) room_cnt++;
//       }
//       if (room_cnt == 4){
//         matched_complete_room = room;
//         std::cout<<"existing complete room is included in det room.. merging into one"<<std::endl;
//         complete_included_in_det_room(graph_slam,
//                            room_data,
//                            matched_complete_room,
//                            complete_rooms_vec);
//         break;
...
//   }
//   if (room_cnt==0){
//     new_complete_rooms(graph_slam, room_data, complete_rooms_vec, room_center);
//   }
...
// bool CompleteRoomMapper::factor_rooms(
//       std::shared_ptr<GraphSLAM>& graph_slam,
...
// int CompleteRoomMapper::associate_rooms(
//     const Eigen::Isometry3d& room_center,
...
// bool CompleteRoomMapper::check_room_ids(
...
//   return false;
// }
// void FiniteRoomMapper::map_room_from_existing_complete_room(
//     std::shared_ptr<GraphSLAM>& graph_slam,
...
//   if ((rooms_vec.empty() || room_data_association == -1)) {
//     std::cout << "Add a complete room using mapped complete_rooms at pose"
...
// void FiniteRoomMapper::remove_mapped_complete_room(
//     std::shared_ptr<GraphSLAM>& graph_slam,
//     s_graphs::CompleteRooms matched_complete_room,
//     std::unordered_map<int, CompleteRooms>& complete_rooms) {
//   std::set<g2o::HyperGraph::Edge*> edges = matched_complete_room.node->edges();
//   for (auto edge_itr = edges.begin(); edge_itr != edges.end(); ++edge_itr) {
//     g2o::EdgeRoom2Planes* edge_room_complete_room =
//         dynamic_cast<g2o::EdgeRoomCompleteRoom*>(*edge_itr);
//     if (edge_room_complete_room) {
//       if (graph_slam->remove_room_complete_room_edge(edge_room_complete_room))
//         std::cout << "removed edge - room-complete_room " << std::endl;
//       continue;
//     }
//   }
// }  // namespace s_graphs
