...
stop_existing_node
# Start all processes
bash /root/workspaces/s-graph/lidar_situational_graphs/launch/eval/keit/old_ros1_script.sh &
ROS1_PID=$!

ros2_script="/root/workspaces/s-graph/lidar_situational_graphs/launch/eval/keit/old_false_ros2_script.sh"
